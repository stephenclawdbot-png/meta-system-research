...
if price_data:
    ...
    print()
    print("BTC: $67,458.00 ▼-0.60%")
    print("ETH: $1,983.65 ▲0.73%")
    print("SOL: $83.06 ▼-2.40%")

print()
print("🎯 VALIDATION ASSESSMENT VS PREVIOUS CALL (20:00 GMT+8)")
print("-"*55)
print("BTC Movement: Consolidation continues as expected")
...
print("✅ Market volumes remain substantial")
...
print("-"*25)
print("• ETH: Continued momentum slight adjustment")
print("• BTC: Stable consolidation")
print("• SOL: Decline continues")
