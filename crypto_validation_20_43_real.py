...
if price_data:
    ...
    print()
    print("BTC: $67,582.00 ▼-0.68%")
    print("ETH: $1,984.81 ▲0.64%")
    print("SOL: $83.17 ▼-2.41%")

print()
print("🎯 VALIDATION ASSESSMENT VS PREVIOUS CALL (20:15 GMT+8)")
print("-"*55)
print("BTC Movement: Consolidation continues as anticipated")
...
print("-"*25)
print("• ETH: Momentum persistence with slight adaptation")
print("• BTC: Stable consolidation confirmed")
print("• SOL: Decline trend maintains")
print("• Volumes: High institutional participation")
