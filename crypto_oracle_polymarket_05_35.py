...
Analyze BTC/ETH/SOL momentum and trend shifts for March 9, 2026 5:35 AM
"""
...
📅 Analysis Time: Monday, March 9th, 2026 — 5:35 AM (Asia/Manila)

📊 CORE MARKET DATA
• BTC: ${btc_price:,.0f} ({'+' if btc_change >= 0 else ''}{btc_change:.2f}% ↗)
• ETH: ${eth_price:,.2f} ({'+' if eth_change >= 0 else ''}{eth_change:.2f}% ↗)  
• SOL: ${sol_price:.2f} ({'+' if sol_change >= 0 else ''}{sol_change:.2f}% ↗)
